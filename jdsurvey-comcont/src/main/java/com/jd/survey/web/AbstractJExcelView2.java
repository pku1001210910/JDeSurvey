...
public abstract class AbstractJExcelView2 extends AbstractView {
	...
	protected final void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (this.url != null) {
			...
			// this was modified from the standard AbstractJExcelView2 spring
			// library to handle an error parsing out the
	 ...
	 *             in case of failure
	 */
	protected abstract void buildExcelDocument(Map<String, Object> model, WritableWorkbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception;
