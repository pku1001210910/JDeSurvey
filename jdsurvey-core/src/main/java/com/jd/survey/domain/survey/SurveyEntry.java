...
public class SurveyEntry implements Serializable, Comparable<SurveyEntry> {
	...
	public SurveyEntry(Long surveyId, Long surveyDefinitionId, String createdByIpAddress, String departmentName, String surveyName, String createdByLogin,
			String createdByFirstName, String createdByMiddleName, String createdByLastName, String createdByEmail, Date creationDate, Date lastUpdateDate, Date submissionDate,
			SurveyStatus status) {
		super();
