...
public enum SurveyTheme {
	...
	STANDARD("STANDARD"), STEEL_BLUE("STEEL_BLUE"), DEEP_CHESTNUT("DEEP_CHESTNUT"), SPRING_GREEN("SPRING_GREEN"), FRENCH_LILAC("FRENCH_LILAC"), CELESTIAL_BLUE(
			"CELESTIAL_BLUE"), PEACH_ORANGE("PEACH_ORANGE");
