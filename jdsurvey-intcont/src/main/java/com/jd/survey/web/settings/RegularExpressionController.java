...
public class RegularExpressionController {
	...
	public String createPost(@RequestParam(value = "_proceed", required = false) String proceed, @Valid RegularExpression regularExpression, BindingResult bindingResult,
		...
		try {
			...
			if (proceed != null) {
				...
				return "redirect:/admin/masks";// +
												// encodeUrlPathSegment(regularExpression.getId().toString(),
												// httpServletRequest);
			} else {
				return "redirect:/admin/masks";
			}
	...
	public String update(@RequestParam(value = "_proceed", required = false) String proceed, @Valid RegularExpression regularExpression, BindingResult bindingResult,
			Principal principal, Model uiModel, HttpServletRequest httpServletRequest) {
