...
public class TopMenuController {
	 ...
	 * homeForm(ModelMap uiModel) { uiModel.addAttribute("homeActive", true);
	 * return "home/index"; }
	 * 
	 * 
	 * @Secured({"ROLE_ADMIN","ROLE_SURVEY_ADMIN"})
	 * 
	 * @RequestMapping(value="surveys", method = RequestMethod.GET) public
	 * String surveysForm(ModelMap uiModel) {
	 * uiModel.addAttribute("surveysActive", true); return "settings/index";; }
	 * 
	 * 
	 * @Secured({"ROLE_ADMIN","ROLE_SURVEY_ADMIN"})
	 * 
	 * @RequestMapping(value="reports", method = RequestMethod.GET) public
	 * String reportsForm(ModelMap uiModel) {
	 * uiModel.addAttribute("reportsActive", true); return "settings/index"; }
	 */
