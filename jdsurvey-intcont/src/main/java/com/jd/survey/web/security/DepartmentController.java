...
public class DepartmentController {
	...
	public String createPost(@RequestParam(value = "_proceed", required = false) String proceed, @Valid Department department, BindingResult bindingResult, Principal principal,
	...
	public String list(@RequestParam(value = "s", required = false) Integer showDeleteFailMessage, @RequestParam(value = "page", required = false) Integer page,
	...
	public String update(@RequestParam(value = "_proceed", required = false) String proceed, @Valid Department department, BindingResult bindingResult, Principal principal,
			Model uiModel, HttpServletRequest httpServletRequest) {
