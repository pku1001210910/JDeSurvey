...
public class StatisticsController {
	...
	public String listSurveyEntries(@RequestParam(value = "sid", required = true) Long surveyDefinitionId, @RequestParam(value = "qid", required = false) Long questionId,
	...
	public ModelAndView exportSurveyToPdf(@PathVariable("id") Long surveyDefinitionId, Principal principal, HttpServletRequest httpServletRequest, HttpServletResponse response) {
	...
	public void generatePieChart(@PathVariable("surveyDefinitionId") Long surveyDefinitionId, @PathVariable("questionId") Long questionId, HttpServletResponse response) {
		try {
	...
	private PieDataset createDataset(Long questionId, Long recordCount) {
		try {
			...
			for (QuestionStatistic questionStatistic : questionStatistics) {
				// double percentage =
				// ((double)questionStatistic.getCount()/(double)recordCount) *
				// 100;
				// percentage = Double.valueOf(new
	...
	private JFreeChart createChart(PieDataset pieDataset, String title) {
		try {
			...
			chart.setBackgroundPaint(null);// this line necessary for
											// transparency of background
			final ChartPanel chartPanel = new ChartPanel(chart);
			chartPanel.setOpaque(false); // this line necessary for transparency
											// of background
			chartPanel.setBackground(new Color(0, 0, 0, 0)); // this line
																// necessary for
																// transparency
																// of background
			...
			// Color[] colors = {new Color(170, 195, 217, 255),new Color(246,
			// 140, 31, 255),new Color(204, 204, 204, 255),new Color(231, 238,
			// 144, 255),new Color(51, 51, 51, 255),new Color(101, 125, 151,
			// 255),new Color(0, 102, 255, 255)};
