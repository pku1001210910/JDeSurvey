...
public class DataSetController {
	...
	public String importDatasetItems(@RequestParam("file") MultipartFile file, @RequestParam("id") Long dataSetId, @RequestParam("ignoreFirstRow") Boolean ignoreFirstRow,
		...
		try {
			...
			if (proceed != null) {
				...
				// if file is empty OR the file type is incorrect the upload
				// page is returned with an error message.
	...
	public String createPost(@RequestParam(value = "_proceed", required = false) String proceed, @Valid DataSet dataSet, BindingResult bindingResult, Principal principal,
	...
	public String show(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size,
	...
	public String update(@RequestParam(value = "_proceed", required = false) String proceed, @Valid DataSet dataSet, BindingResult bindingResult, Principal principal,
			Model uiModel, HttpServletRequest httpServletRequest) {
